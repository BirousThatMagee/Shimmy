...
#All the tips that will displayed
...
class GetGud:
    ...
    #clear the page and ask what game category you are playing
    def first_page(self):
        self.delete_buttons()
    ...
    def second_page(self):
        ...
        photo = self.Insert_Image()#shows the example image based on the game category
        ...
        self.button8.pack()#return button to go tom the starting page
    ...
    def Favorite_Page(self):
        ...
        for element in self.favorites:
            ...
            #after you favorite a tip, it will be shown on the favorite page
    ...
    #these are the codes that generate the tips for each category
